...
import 'package:soleilshop_admin/views/newproduct.dart';
...
class _ProductScreenState extends State<ProductScreen> {
                              ...
                              Flexible(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: CONSTANTS.server +
                                      "/soleilshop/mobile/assets/products/" +
  ...
  void _loadProducts(int pageno, String _search) {
    ...
    http.post(
        Uri.parse(
            CONSTANTS.server + "/soleilshop/mobile/php/load_products.php"),
        body: {
  ...
  void _deleteProduct(int index) {
    http.post(
        Uri.parse(
            CONSTANTS.server + "/soleilshop/mobile/php/delete_product.php"),
